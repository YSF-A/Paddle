...
MatmulJudgeDtypeKernel(const Context& ctx,
                       ...
                       bool transpose_x,
                       bool transpose_y) {
  bool try_cublasLt = MatMulInt8Function<Context>(
...
// template <>
// void MatmulWithFlattenInt8Kernel<signed char, phi::CPUContext>(
...
//     int y_num_col_dims,
//     DenseTensor* out) {
//   MatmulWithFlattenInt8Kernel<int8_t, phi::GPUContext>(
