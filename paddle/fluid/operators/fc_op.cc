...
//           2,
//           platform::errors::InvalidArgument(
//               "The input Bias of fc is expected to be a 1-D or 2-D tensor.
//               But " "received the number of Bias's dimensions is %d, "
//               "Bias's shape is %s.",
//               bias_dims.size(),
//               bias_dims));
...
//               "The Input of fc is expected to be a 2-D, 3-D or 4-D tensor
//               when " "use_mkldnn is set. But received the number of Input's "
...
//                    "(float, default 1.0f), The quantize scale of output
//                    data")
//         .SetDefault(1.0f);
...
// The fully connected operation calculates the output based on the input,
// weights and bias. The size of each dimension of the parameters checked in the
// infer-shape. )DOC");
//   }
// };
...
// PD_REGISTER_STRUCT_KERNEL(fc, CPU, ALL_LAYOUT, ops::FCOpKernel, float,
// double) {
}
